...
describe('website main elements', function() {
    ...
    it('Verify the forgot password functionality', function(browser) {
        ...
        browser.expect.element('.pf-c-alert__title.kc-feedback-text').text.to.contains('You should receive an email shortly with further instructions.');  //forgotPasswordMessage
    });
    ...
    it('Verify login with invalid credentials with an alert message', function(browser) {
        ...
        browser.expect.element('#input-error').text.to.contains("Invalid username or password");   //invalidLoginErrorMessage
    });
